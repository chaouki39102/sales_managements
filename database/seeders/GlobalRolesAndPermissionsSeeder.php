 ...
 * ══════════════════════════════════════════════════════════════════
 * مسؤول حصراً عن:
 *   1. إنشاء الصلاحيات العالمية (company_id = null)
 *   2. إنشاء دور super-admin العالمي ومنحه كل الصلاحيات
 *   3. تعيين دور super-admin للمستخدم الأول
 *
 * لا يلمس أي بيانات شركة.
 * أدوار الشركة تُنشأ عبر CompanyRoleService::seedRoles()
 * ══════════════════════════════════════════════════════════════════
 */
class GlobalRolesAndPermissionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $this->command?->info("✅ {$count} صلاحية + دور super-admin");
    }
    ...
    private function seedSuperAdminRole(): void
    {
        ...
        $role->syncPermissions(Permission::whereNull('company_id')->get());
    }
    ...
    private function assignSuperAdminUser(): void
    {
        ...
        if (!$user) {
            $this->command?->warn("⚠️  لم يُعثر على {$email} — تخطي تعيين الدور");
            return;
        }
        ...
        if ($role) {
            $user->syncRoles([$role]);
            $this->command?->line("  ↳ super-admin ← {$email}");
        }
    }

    // ─────────────────────────────────────────────────────────────
    // قائمة الصلاحيات العالمية الكاملة
    // ─────────────────────────────────────────────────────────────
    ...
    private function getPermissions(): array
    {
        return [
            ...
            // 1. المستخدمون
            ['name' => 'view_any_user',        'display_name' => 'عرض قائمة المستخدمين',    'group' => 'المستخدمون'],
            ['name' => 'view_user',            'display_name' => 'عرض مستخدم',              'group' => 'المستخدمون'],
            ['name' => 'create_user',          'display_name' => 'إنشاء مستخدم',            'group' => 'المستخدمون'],
            ['name' => 'update_user',          'display_name' => 'تعديل مستخدم',            'group' => 'المستخدمون'],
            ['name' => 'delete_user',          'display_name' => 'حذف مستخدم',              'group' => 'المستخدمون'],
            ['name' => 'restore_user',         'display_name' => 'استعادة مستخدم',          'group' => 'المستخدمون'],
            ['name' => 'force_delete_user',    'display_name' => 'حذف نهائي لمستخدم',       'group' => 'المستخدمون'],
            ['name' => 'toggle_active_user',   'display_name' => 'تفعيل/تعطيل مستخدم',      'group' => 'المستخدمون'],
            ['name' => 'change_password_user', 'display_name' => 'تغيير كلمة مرور مستخدم',  'group' => 'المستخدمون'],
            ['name' => 'assign_role_user',     'display_name' => 'تعيين دور لمستخدم',       'group' => 'المستخدمون'],

            // 2. الأطراف
            ['name' => 'view_any_party',     'display_name' => 'عرض قائمة الأطراف', 'group' => 'الأطراف'],
            ['name' => 'view_party',         'display_name' => 'عرض طرف',           'group' => 'الأطراف'],
            ['name' => 'create_party',       'display_name' => 'إنشاء طرف',         'group' => 'الأطراف'],
            ['name' => 'update_party',       'display_name' => 'تعديل طرف',         'group' => 'الأطراف'],
            ['name' => 'delete_party',       'display_name' => 'حذف طرف',           'group' => 'الأطراف'],
            ['name' => 'restore_party',      'display_name' => 'استعادة طرف',       'group' => 'الأطراف'],
            ['name' => 'force_delete_party', 'display_name' => 'حذف نهائي لطرف',    'group' => 'الأطراف'],
