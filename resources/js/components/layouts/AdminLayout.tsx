    ...
    >
      ...
      >
        ...
        <div style={{ padding: '10px 6px', borderTop: '1px solid var(--b2)', flexShrink: 0 }}>
          ...
          >
            <i className="ti ti-arrow-back-up" style={{ fontSize: 16, flexShrink: 0 }} />
          ...
          >
            <i
              className={`ti ${collapsed ? 'ti-layout-sidebar-right-expand' : 'ti-layout-sidebar-right-collapse'}`}
              style={{ fontSize: 16, flexShrink: 0 }}
            />
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <button
              ...
              style={{
                ...
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                cursor: 'pointer', color: 'var(--t3)', fontSize: 15,
              }}
            >
            ...
            <div ref={notifRef} style={{ position: 'relative' }}>
              <button
                ...
                style={{
                  ...
                  border: '1px solid var(--b2)', background: 'var(--bg3)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  cursor: 'pointer', color: 'var(--t3)', fontSize: 15, position: 'relative',
                }}
              >
                    ...
                    <div style={{
                      ...
                      <div>
                        <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--t1)' }}>
                          {stats.companies.suspended} شركة موقوفة
                        </div>
                        <div style={{ fontSize: 10.5, color: 'var(--t4)', marginTop: 2 }}>
                          بحاجة للمراجعة والمتابعة
                        </div>
                      </div>
                    </div>
                  )}
                  {stats?.companies.on_trial !== undefined && stats.companies.on_trial > 0 && (
                    <div style={{
                      padding: '10px 14px', borderBottom: '1px solid var(--b2)',
                      display: 'flex', gap: 10, alignItems: 'flex-start',
                    }}>
                      ...
                      <div>
                        <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--t1)' }}>
                          {stats.companies.on_trial} شركة في فترة التجربة
                        </div>
                        <div style={{ fontSize: 10.5, color: 'var(--t4)', marginTop: 2 }}>
                          قد تحتاج تحويلًا لخطة مدفوعة
                        </div>
                      </div>
                    </div>
                  )}
                  <div style={{ padding: '10px 14px', textAlign: 'center' }}>
                    <span style={{ fontSize: 11, color: 'var(--t4)' }}>لا توجد إشعارات إضافية</span>
                  </div>
                </div>
              )}
            </div>
