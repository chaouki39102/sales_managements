...
Route::prefix('notifications')->controller(NotificationController::class)->group(function () {
    Route::get('/',                'index');           // 🆕 GET    /notifications  (paginated + filters)
    ...
    Route::delete('/{id}',         'destroy');           // 🆕 DELETE /notifications/{id}
    Route::post('/delete-multiple','deleteMultiple');    // 🆕 POST   /notifications/delete-multiple
});
