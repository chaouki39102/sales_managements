...
export default function MarginReportPage() {
  ...
  return <ReportShell title="تقرير الهوامش" subtitle={`هامش الربح والتكاليف — ${fromDate} → ${toDate}`} onExport={handleExport} isLoading={isLoading} isError={isError} refetch={refetch} reportId="margin">
