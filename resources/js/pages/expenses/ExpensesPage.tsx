        ...
        (data: typeof form) => {
            const payload = {
                ...
                payment_mode_id: data.payment_mode_id
                    ? parseInt(String(data.payment_mode_id))
                    : null,
                treasury_account_id: data.treasury_account_id
                    ? parseInt(String(data.treasury_account_id))
                    : null,
                party_id: data.party_id
                    ? parseInt(String(data.party_id))
                    : null,
            ...
            <div className="fgrid c2" style={{ gap: 14 }}>
                ...
                <div className="fg">
                    ...
                    <select
                        ...
                        onChange={(e) =>
                            set("expense_category_id", e.target.value)
                        }
                        style={{
                            borderColor: errors.expense_category_id
                                ? "var(--red)"
                                : undefined,
                        }}
                    >
                ...
                <div className="fg">
                    ...
                    <select
                        ...
                        onChange={(e) => set("payment_mode_id", e.target.value)}
                    >
                ...
                <div className="fg">
                    ...
                    <select
                        ...
                        onChange={(e) =>
                            set("treasury_account_id", e.target.value)
                        }
                    >
                        <option value="">— غير محدد —</option>
