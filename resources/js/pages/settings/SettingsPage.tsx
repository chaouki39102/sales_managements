...
function DocumentsTab({
    ...
    const initialSettings = useMemo(
        () => ({
            ...
            default_is_proforma: gs<boolean>("default_is_proforma", false),
    ...
    useEffect(() => {
        ...
        setIsProforma(gs<boolean>("default_is_proforma", false));
    ...
    const doSave = async () => {
        const current = {
            ...
            default_is_proforma: isProforma,
        ...
        <div>
            ...
            <Card>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                    ...
                    />
                    <ToggleRow
                        label="مبدئي (Pro Forma) افتراضياً"
                        hint="المستندات الجديدة تكون مبدئية"
                        checked={isProforma}
                        onChange={v => { setIsProforma(v); markDirty(); onDirty?.(); }}
                    />
                    <ToggleRow
