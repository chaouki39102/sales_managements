...
export const lookupsApi = {
  ...
  documentTypes:     () => client.get<{ data: DocumentType[] }>('/document-types').then(r => r).catch(() => ({ data: { data: [] as DocumentType[] } })),
  paymentModes:      () => client.get<{ data: PaymentMode[] }>('/payment-modes'),
  treasuryAccounts:  () => client.get<{ data: TreasuryAccount[] }>('/treasury-accounts'),
  treasuryAccountTypes: () => client.get<{ data: unknown[] }>('/treasury-account-types'),
