...
interface ResourceConfig<T> {
  /** اسم الـ resource في URL (e.g. 'products', 'parties') */
  resource:    string;
  /** مفتاح React Query (يُبنى هرمياً: [slug, resource, ...]) */
  queryKey:    (slug: string, params?: unknown) => readonly unknown[];
  /** staleTime بالـ ms */
  staleTime?:  number;
}
...
export function createResourceHooks<T extends BaseModel>(config: ResourceConfig<T>) {
