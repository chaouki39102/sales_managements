...
- **Full code review pending** — `CODE_REVIEW_TODO.md` (project root) is the checklist with 8 sections (backend services, controllers/models, frontend core/offline, POS, portal, documents, print/settings, shared hooks). Work task-by-task, commit + push after each section.
