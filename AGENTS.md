...
- **Full code review in progress** — `CODE_REVIEW_TODO.md` (project root) is the checklist with 8 sections (backend services, controllers/models, frontend core/offline, POS, portal, documents, print/settings, shared hooks). Sections 1–4 complete (51 findings: 32 fixed + 19 observations). Next: **Section 5 — Portal**. Work task-by-task, commit + push after each section.
