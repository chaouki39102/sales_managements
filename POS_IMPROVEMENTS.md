...
8. **شاشة عرض الزبون (Customer Display)** — عرض الأصناف والمبلغ الإجمالي في شاشة ثانية موجهة للزبون.
...
3.2 شاشة عرض الزبون (Customer Display)
لماذا؟
تحسين تجربة الزبون برؤية الأصناف والمبلغ الإجمالي.
...
إضافة زر "عرض للزبون" في ProfessionalCart.
...
| شاشة عرض الزبون | يتطلب BroadcastChannel API |
...
- **شاشة عرض الزبون** — BroadcastChannel API
