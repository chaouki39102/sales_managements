...
class StoreProductVariantPriceRequest extends FormRequest
{
    ...
    {
        return [
            'product_id' => 'required|exists:product_variants,id', 'price_level_id' => 'required|exists:price_levels,id',
...
class UpdateProductVariantPriceRequest extends FormRequest
{
    ...
    {
        return [
            'product_id' => 'sometimes|exists:product_variants,id', 'price_level_id' => 'sometimes|exists:price_levels,id',
