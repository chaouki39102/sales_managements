...
> **حالة عامة (آخر تحديث: 2026-09-06):** **جميع المهام الـ 15 مكتملة ومُدفوعة على `main`** — المجموعات أ (1–4)، ب (5–8)، ج (9–12)، د (13–15: استرجاع المخزون عند الإلغاء، حذف آمن + حراسة الدفعات، حماية التعديل المتزامن/التحكم المتزامن بالنسخ CAS).
