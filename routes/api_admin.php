...
|--------------------------------------------------------------------------
|
| يُضمَّن من api.php عبر: require base_path('routes/api_admin.php');
|
| ✅ هذا الملف هو المرجع الوحيد لمسارات /api/v1/admin/*
|    مسارات admin في api.php القديمة يجب حذفها أو تجاهلها (انظر التعليق أسفله)
|
*/

Route::prefix('admin')
    ->middleware(['api.auth', 'super.admin'])
    ->name('admin.')
    ->group(function () {
        ...
        // ⚠️ يجب أن يكون 'stop' قبل '{user}' لتجنب التعارض في الـ routing
